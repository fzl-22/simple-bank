...
func TestGetTransfer(t *testing.T) {
	...
	createdTransfer := createRandomTransfer(t, account1, account2)
	...
	require.Equal(t, createdTransfer.FromAccountID, fetchedTransfer.FromAccountID)
	require.Equal(t, createdTransfer.ToAccountID, fetchedTransfer.ToAccountID)
